      ...
      <div className="max-w-5xl mx-auto space-y-8 sm:space-y-10">
        ...
        <div className="flex flex-wrap justify-center gap-4 pt-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          ...
          <Link to="/workflow/new">
            ...
            >
              <GitBranch className="h-5 w-5 me-2 group-hover:rotate-180 transition-transform duration-500" />
              {t("hero.try_workflow")}
            </Button>
          </Link>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 sm:gap-10 pt-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="text-sm sm:text-base">{t("hero.stats.tools")}</span>
          </div>
          <div className="flex items-center gap-2 text-muted-foreground">
            <Users className="h-5 w-5 text-neon-blue" />
            <span className="text-sm sm:text-base">{t("hero.stats.users")}</span>
          </div>
          <div className="flex items-center gap-2 text-muted-foreground">
            <Star className="h-5 w-5 text-neon-cyan" />
            <span className="text-sm sm:text-base">{t("hero.stats.updates")}</span>
          </div>
        </div>
        ...
        <button
          ...
          aria-label={t("hero.scroll_to_tools")}
        >
