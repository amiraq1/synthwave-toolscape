...
export const ToolsSorter: React.FC<ToolsSorterProps> = ({ className, onSortChange }) => {
                ...
                {SORT_OPTIONS.map((option) => {
                    ...
                    return (
                        <button
                            ...
                            aria-label={`ترتيب حسب ${option.labelAr}`}
                            className={cn(
                        ...
                        >
                            ...
                            <span className="relative z-20 flex items-center gap-2 pointer-events-none">
                                ...
                                />
                                <span className="tracking-wide">{option.labelAr}</span>
                            </span>
