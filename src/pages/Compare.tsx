...
const ComparePage = () => {
    ...
    if (tools.length === 0) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-[#0f0f1a] p-4 text-center font-cairo" role="main" dir="rtl">
    ...
    return (
        <div className="min-h-screen bg-[#0f0f1a] pt-24 pb-20 px-4 md:px-8 font-cairo" role="main" dir="rtl">
            <Helmet>
                            ...
                            {tools.map(tool => {
                                ...
                                return (
                                    <div key={tool.id} className="relative p-6 flex flex-col items-center text-center border-l border-white/10 last:border-0 bg-white/[0.02]">
                                        ...
                                        <span className="text-xs text-neon-cyan bg-neon-cyan/10 border border-neon-cyan/20 px-2.5 py-1 rounded-full">{getCategoryLabel(tool.category, true)}</span>
