                ...
                <main className="flex-1 container mx-auto max-w-7xl px-4 py-20 flex flex-col items-center justify-center">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-muted-foreground max-w-md mx-auto">
                            سجّل الدخول لحفظ أدواتك المفضلة والوصول إليها في أي وقت.
                        </p>
                        <Button
        ...
        <div className="min-h-screen bg-background flex flex-col" dir="rtl">
            <main className="flex-1 container mx-auto max-w-7xl px-4 py-8">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold gradient-text">المحفوظات</h1>
                        <p className="text-muted-foreground">الأدوات التي حفظتها</p>
                    </div>
                </div>
                ...
                {isLoading && (
                    <div className="flex justify-center items-center py-20 min-h-[400px]">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <span className="text-muted-foreground animate-pulse">جاري تحميل المحفوظات...</span>
                        </div>
                    </div>
                )}
                ...
                {error && (
                    <div className="text-center py-20 min-h-[400px] flex flex-col justify-center items-center">
                        ...
                        <p className="text-xl font-bold text-destructive mb-2">خطأ</p>
                        <p className="text-muted-foreground">فشل تحميل المحفوظات</p>
                    </div>
                )}
                ...
                {!isLoading && !error && (!tools || tools.length === 0) && (
                    <div className="text-center py-20 min-h-[400px] flex flex-col justify-center items-center">
                        ...
                        <p className="text-xl font-semibold text-foreground">لا توجد أدوات محفوظة بعد</p>
                        <p className="text-muted-foreground mt-2 max-w-xs mx-auto">
                            اضغط على أيقونة القلب في أي أداة لحفظها هنا.
                        </p>
                        <Button
                            onClick={() => navigate('/')}
                            variant="outline"
