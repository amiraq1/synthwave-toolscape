    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center" role="main" dir={isAr ? "rtl" : "ltr"}>
            <Helmet>
                ...
                <meta name="description" content={isAr ? "تصفح واستخدم وكلاء ذكاء اصطناعي جاهزين للتشغيل." : "Browse and use ready-to-run AI agents."} />
            </Helmet>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 max-w-md w-full backdrop-blur-sm">
                ...
                <p className="text-gray-400 mb-8">
                    {isAr ? "سوق الوكلاء قيد التطوير حالياً. قريباً المزيد." : "The marketplace is under active development. More soon."}
                </p>
