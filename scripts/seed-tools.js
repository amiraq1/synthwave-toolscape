...
const tools = [
    ...
    { title: 'Rytr', description: 'مساعد كتابة ذكي يدعم اللغة العربية بشكل جيد جداً وبأسعار مجانية.', url: 'https://rytr.me', category: 'نصوص', pricing_type: 'Freemium', features: ['writing assistant', 'arabic support', 'blogging'], supports_arabic: true, is_featured: false, is_published: true },
    ...
    { title: 'Tome', description: 'إنشاء قصص وعروض تقديمية تفاعلية بذكاء اصطناعي سردي مميز.', url: 'https://tome.app', category: 'إنتاجية', pricing_type: 'Freemium', features: ['storytelling', 'presentations', 'interactive'], supports_arabic: false, is_featured: false, is_published: true },
    ...
    { title: 'Aesthete', description: 'أداة لاكتشاف وتنسيق الألوان والخطوط بناءً على ذوقك الفني.', url: 'https://aesthete.ai', category: 'صور', pricing_type: 'مجاني', features: ['colors', 'fonts', 'design'], supports_arabic: false, is_featured: false, is_published: true },
